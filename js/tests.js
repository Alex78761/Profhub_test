class SensomotorTest {
    ...
    playSoundMathStimulus() {
        ...
        // Запоминаем сумму для проверки ответа
        this.currentNumber = firstNumber + secondNumber;
        
        // Последовательность аудиофайлов для воспроизведения
        const audioFiles = [
            `audioNum/bot${firstNumber}.mp3`,
            'audioNum/botPlus.mp3',
            `audioNum/bot${secondNumber}.mp3`
        ];
        
        // Счетчик воспроизведенных файлов
        let audioIndex = 0;
        
        // Флаг, указывающий начало отсчета времени
        this.startTime = null;
